...
object CompletableOperators {
    ...
    object Task3 {
         ...
         */
        fun solve(worker: Worker): Completable = TODO()
    ...
    object Task4 {
         ...
         */
        fun solve(source: Single<String>): Completable = TODO()
    }
    ...
    object Task5 {
         ...
         */
        fun solve(first: Completable, second: Completable, third: Completable): Completable = TODO()
    }
    ...
    object Task6 {
         ...
         */
        fun solve(source: Completable, scheduler: Scheduler): Completable = TODO()
    }
